"""add_projects_dependencies_timers

Revision ID: b562c62ee749
Revises: 8cdf10de16b1
Create Date: 2026-07-16 18:21:05.193230
...
revision: str = 'b562c62ee749'
down_revision: Union[str, Sequence[str], None] = '8cdf10de16b1'
...
def upgrade() -> None:
    ...
    with op.batch_alter_table('tasks', schema=None) as batch_op:
        ...
        batch_op.create_foreign_key('fk_tasks_project_id_projects', 'projects', ['project_id'], ['id'], ondelete='SET NULL')
